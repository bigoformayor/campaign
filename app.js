(function(){
  ...
  const i18n = {
    en: {
      ...
      hero: { title: 'Neighbors first. Galena Park first.', subtitle: 'A community-built space for straight talk, local news, and shared goals.', ctaAbout: 'What is Galena Park 1st?', ctaNews: 'See the latest' },
    ...
    es: {
      ...
      hero: { title: 'Vecinos primero. Galena Park primero.', subtitle: 'Un espacio creado por la comunidad para hablar claro, compartir noticias y avanzar juntos.', ctaAbout: '¿Qué es Galena Park 1st?', ctaNews: 'Ver lo más reciente' },
  ...
  function escapeHTML(s){ return (s||'').replace(/[&<>]/g, c => ({'&':'&amp','<':'&lt','>':'&gt'}[c])); }
